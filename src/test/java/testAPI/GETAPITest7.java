...
public class GETAPITest7 extends TestBase{
	...
	public void getAPITest() {
		...
		Response response = RestAssured.given().when().get(APIPath.apiPath.GET_SPECIFIC_DATE_FOREIGN_EXCHANGE_RATE_WITH_SYMBOLS_WITH_BASE);
	...
	public void getAPITest1() {
		...
		RestAssured.given().when().get(APIPath.apiPath.GET_SPECIFIC_DATE_FOREIGN_EXCHANGE_RATE_WITH_SYMBOLS_WITH_BASE).then().log().all().statusCode(400);
