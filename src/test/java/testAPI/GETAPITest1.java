...
public class GETAPITest1 extends TestBase{
	...
	public void getAPITest() {
		...
		Response response = RestAssured.given().when().get(APIPath.apiPath.GET_LATEST_FOREIGN_EXCHANGE_RATE_SYMBOL);
	...
	public void getAPITest1() {
		...
		RestAssured.given().when().get(APIPath.apiPath.GET_LATEST_FOREIGN_EXCHANGE_RATE_SYMBOL).then().log().all().statusCode(400);
		
		
		Response response = RestAssured.given().when().get(APIPath.apiPath.GET_LATEST_FOREIGN_EXCHANGE_RATE);
